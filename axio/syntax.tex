...
morekeywords=[1]{
Linear,Arith,Builtin,Fraction,Dimension,Linear, PLam, PApp, I, And, Or, Neg, Transp, HComp, Partial, PartialP, System, Sub, Inc, Ouc, GlueElem, Unglue,
Homotopy,Inductive,
application,identity,id_compute,fibrant,W,0,1,2,W_Sup,W_Ind,W_Form,prop,formation,eliminator,pretype,path,path_lambda,path_app,homotopy,Empty,Bool,
record,data,inductive,extend,enum,theorem,tensor,bra,constructor,homotopy,hcomp,transp,neg,interval,zero,one,meet,join,
...
branch,label,ctor,sum,prod,ty,lam,split,Glue,glue,unglue,Pi,Equ,Id,Ind,IndForm,Sigma,pr1,pr2,Beta,Eta,Beta1,Beta2,Eta2,refl,ap,apply,apd,J,
...
morekeywords=[3]{PTS,CIC,MLTT,HTS,CPS,CCHM,CHM,
Alice,Bob,Joe,Jack,Urs,Fabien,Dan,Christine,Per,Frank,Errett,Ersnt,Julius,Paul,Anders,Henk,
Leslie
},
...
% Style for sorts
keywordstyle=[3]{\ttfamily\color{keywordcolor2}},
