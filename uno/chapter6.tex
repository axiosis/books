...
i) правила формації або сигнатура типу;
ii) множина конструкторів за допомогою яких рекурсивно будують елементи типу певної сигнатури;
iii) залежний елімінатор принципу індукції для цього типу;
iv) бета-рівняння або правило обчислення;
v) ета-рівняння або принцип унікальності.
