...
intuitionistic theory of types: predicative part. 1975.}{1975} в 1975.
...
\subsubsection{Інтерпретації теорії типів}
...
1) теоертико-типову;
2) категоріальну;
3) теоретико-множинна;
4) гомотопічна;
5) фібраційна або геометрична.
...
вбудовуватися додаткоого, а саме визначення множини моделюється в гомотопічній
теорії як n-тип. Наявність принципу унікальності
доведень рівності (UIP) в типовій системі означає теоретико-множинну інтерпретацію.
