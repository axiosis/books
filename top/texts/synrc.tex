    ...
    \begingroup
        ...
        \parbox[c][][s]{0.75\textwidth}
        {
            ...
            \\
             ...
             \\
             \Large
             Топовий програміст\\[0.5\baselineskip]
             \\
             \small
             Поклоніння та вираження поваги \\
             Перевірка мотивація \\
             Коштовності та чесноти як хакактеристики мислення \\
             Яди мислення \\
             Спочатку йога розуму, потім тіла \\
             Баланс та не-медитація \\
             Структура курсу \\
             Гранична точність, оптимальність та складність \\
             Самостійність \\
             Створення власної школи \\
             Дракон \\
             Лямбдагарбха \\
             Гротендік \\
             Будда \\
             Програмування як спорт \\
             Баланс \\
             }
        }}
    \endgroup
